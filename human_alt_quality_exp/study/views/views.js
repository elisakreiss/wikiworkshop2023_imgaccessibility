...
var intro = {
    ...
    // introduction text
    text:
        "Thank you for participating in our study!<br><br>In this study, you will see 5 short articles that contain an image. Each image will have a description associated with it in order to make the image accessible to users who can't see it. Your task will be to rate these descriptions by answering questions about them. The whole study should take no longer than <strong>9 minutes</strong>.<br><br>Please only participate once in this series of studies.<br>Please do <strong>not</strong> participate on a mobile device since the page won't display properly.<br><small>If you have any questions or concerns, don't hesitate to contact me at ekreiss@stanford.edu</small> ",
    legal_info:
...
var main = {
    ...
    render: function(CT) {
        ...
        let img_path = 'stimuli/images/' + img_id;
        ...
        $("#main").html(
            Mustache.render(viewTemplate, {
                ...
                q5: "How good is the description for <strong>overall</strong> nonvisual accessibility?",
                q5_slider_left: "Not good",
                q5_slider_right: "Very good",
        ...
        if (
            ...
            $("main").html(
                Mustache.render(viewTemplate, {
                    thanksMessage: this.message,
                    extraMessage:
                        "Please press the button below to confirm that you completed the experiment with Prolific. Your completion code is CNM037GQ.<br />" +
                        "<a href=" +

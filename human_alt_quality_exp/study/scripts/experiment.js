...
exp.customize = function() {
    ...
    main_trials_good = _.shuffle(main_trials.slice(0,15));
    main_trials_bad = _.shuffle(main_trials.slice(15,));
    selected_main_trials = _.shuffle(main_trials_good.slice(0,2).concat(main_trials_bad.slice(0,2)));
